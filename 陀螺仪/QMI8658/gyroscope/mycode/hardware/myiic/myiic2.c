...
#define IIC_SCL_1() HAL_GPIO_WritePin(IIC2_PORT,IIC2_SCL_PIN, GPIO_PIN_SET)
#define IIC_SCL_0() HAL_GPIO_WritePin(IIC2_PORT,IIC2_SCL_PIN, GPIO_PIN_RESET)

#define IIC_SDA_1() HAL_GPIO_WritePin(IIC2_PORT,IIC2_SDA_PIN, GPIO_PIN_SET)
#define IIC_SDA_0() HAL_GPIO_WritePin(IIC2_PORT,IIC2_SDA_PIN, GPIO_PIN_RESET)
#define READ_SDA()  HAL_GPIO_ReadPin(IIC2_PORT,IIC2_SDA_PIN)
