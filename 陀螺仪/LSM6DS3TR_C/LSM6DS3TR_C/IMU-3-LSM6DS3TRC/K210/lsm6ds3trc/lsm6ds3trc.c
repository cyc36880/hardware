...
#define I2C_Slave_Address LSM6DS3TRC_I2CADDR
...
****************************************************************************************************************/
void LSM6DS3TRC_ReadCommand(uint8_t reg_addr, uint8_t* data_buf, uint16_t length)
{
	if(lsm6ds3trc_mode==LSM6DS3TRC_MODE_I2C)
		i2c_recv_data(I2C_DEVICE_0, &reg_addr, 1, data_buf, length);
}

/***************************************************************************************************************
LSM6DS3TRC Write Command
****************************************************************************************************************/
void LSM6DS3TRC_WriteCommand(uint8_t reg, uint8_t* data_buf, uint16_t length)
{
	if(lsm6ds3trc_mode==LSM6DS3TRC_MODE_I2C)
	{
		...
		i2c_send_data(I2C_DEVICE_0, buf, length + 1);
		free(buf);
	}
}
